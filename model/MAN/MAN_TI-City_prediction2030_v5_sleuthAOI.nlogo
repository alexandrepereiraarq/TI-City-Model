...
;; 24. added urban-type patch-own (0 = non-urban, 1 = low income, 2 = medium income, 3 = high income, 4 = seed year built-up)
...
to load-suitability
  ...
  ;; APS: 12.12.2024 new suitability function with road influence
...
to export-output-income-status
  ...
  file-delete "data/out/expansion_income_2023.asc"
  file-open "data/out/expansion_income_2023.asc"
  file-print "ncols         846   \r" ;;\r\n
  file-print "nrows         1078  \r"
  file-print "xllcorner     228167.435700000002   \r"
  file-print "yllcorner     1523128.483699999982   \r"
  file-print "cellsize 150   \r"
...
to export-output-legal-status
  ...
  file-delete "data/out/expansion_formality_2023.asc"
  ...
  file-print "yllcorner     1523128.483699999982   \r"
  file-print "cellsize 150   \r"
  file-print  "NODATA_value  -9999   \r"
...
;; APS: 12.12.2024 new export function, seeks to correct errors
  ...
  ;; set file-name "data/out/expansion_income_2023.asc"
