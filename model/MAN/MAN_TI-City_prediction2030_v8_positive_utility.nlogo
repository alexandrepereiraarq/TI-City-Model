...
to set-weights
  ...
  let data csv:from-file "../data/interim/weights.csv"
...
to load-UDP
  ask patches [
    set UDP ((suburb * dpu-suburb) + (nom-neighbourhood * dpu-neigbhour) + (bu * dpu-bu) +
...
to load-ULI
  ask patches [
    set ULI ((suburb * liu-suburb) + (nom-neighbourhood * liu-neigbhour) + (bu * liu-bu) +
...
to load-UMI
  ask patches [
    set UMI ((suburb * miu-suburb) + (nom-neighbourhood * miu-neigbhour) +  (bu * miu-bu) +
...
to load-UHI
  ask patches [
    ...
    set UHI ((suburb * hiu-suburb) + (nom-neighbourhood * hiu-neigbhour) + (bu * hiu-bu) +
      (cbd * hiu-cbd) + (shoppingmall * hiu-mall) + (markets * hiu-markets) +
      (road * hiu-road) + (density * hiu-density) + (schools * hiu-schools) +
      (attractive * hiu-attractive) + (healthfacilities * hiu-health) + ((random-float 0.1) * hiu-random) +
      (water * hiu-water))
