...
;; 27. created a new agent class: deprived income. created its associates variables () and functions () [COMPLETE]
...
to make-deprived-household-development
  ...
  ask max-n-of (x * 3) d [UDP] [set first-n-UDP 1]
...
to make-mid-income-household-development
  ...
  ask max-n-of (x * 3) d [UMI] [set first-n-UMI 1] ;; APS: This command selects 3 patches of the set d with the highest UMI and sets their first-n-UMI to 1
