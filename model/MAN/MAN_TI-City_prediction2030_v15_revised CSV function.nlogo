...
to set-weights
  ...
  let weight-lists butfirst data ;; Remove the header row
  set global-lists (list
    (list dpu-suburb dpu-neigbhour dpu-bu dpu-cbd dpu-mall dpu-markets dpu-road dpu-density dpu-schools dpu-attractive dpu-health dpu-random dpu-water)
    (list liu-suburb liu-neigbhour liu-bu liu-cbd liu-mall liu-markets liu-road liu-density liu-schools liu-attractive liu-health liu-random liu-water)
    (list miu-suburb miu-neigbhour miu-bu miu-cbd miu-mall miu-markets miu-road miu-density miu-schools miu-attractive miu-health miu-random miu-water)
    (list hiu-suburb hiu-neigbhour hiu-bu hiu-cbd hiu-mall hiu-markets hiu-road hiu-density hiu-schools hiu-attractive hiu-health hiu-random hiu-water)
  )

  foreach weight-lists global-lists [[ weight-list globals-list ] ->
    foreach butfirst weight global [[ weight global ] ->
      set global weight
    ]
  ]
  file-close
  ;; set the maximum number of cells to be selected as allocation candidates
  set dpu-maxof 4
  set liu-maxof 2
  set miu-maxof 2
  set hiu-maxof 4
