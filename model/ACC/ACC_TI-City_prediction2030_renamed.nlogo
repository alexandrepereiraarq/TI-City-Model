...
to load-landvalues
  ...
  set landvalues-dataset gis:load-dataset "in/landvalue_categorical_accra.asc"
...
;;load local plan
to load-splan
  set structureplan-dataset gis:load-dataset "in/structureplan.accra.asc"
...
to load-exclusion
  set exclusion-dataset gis:load-dataset "in/exclusion_accra_new.asc"
...
;;load slope
to load-slope
  set slope-dataset gis:load-dataset "in/slope_accra.asc"
...
to load-title-reg
  set title-dataset gis:load-dataset "in/title_accra.asc"
...
to load-roads
  set road-dataset gis:load-dataset "in/prox_trunkroads.asc"
  gis:apply-raster road-dataset road
  ;;gis:paint road-dataset 0

  set road-presence-dataset gis:load-dataset "in/road-presence.accra.asc"
  gis:apply-raster road-presence-dataset road-presence
end

;;load distance to health facilities
to load-healthfacilities
  set healthfacility-dataset gis:load-dataset "in/prox_healthfacilities.asc"
...
to load-school
  set school-dataset gis:load-dataset "in/prox_school.accra.asc"
...
to load-suburbs
  set suburban-dataset gis:load-dataset "in/prox_suburbancentres.asc"
...
to load-shoppingmalls
  set shoppingmall-dataset gis:load-dataset "in/prox_shoppingmalls.asc"
...
to load-market
  set market-dataset gis:load-dataset "in/prox_markets.asc"
...
to load-airport
  set airport-dataset gis:load-dataset "in/prox_airport.asc"
...
to load-cbd
  set cbd-dataset gis:load-dataset "in/cbd.accra.asc"
  gis:apply-raster cbd-dataset cbd
end

;;load distance to attractive neighbourhood
to load-attractive2015
  set attractive2015-dataset gis:load-dataset "in/attractive2015.accra.asc"
  gis:apply-raster attractive2015-dataset attractive2015
end

;; laod population density
to load-density
  set density-dataset gis:load-dataset "in/density.accra.asc"
...
to load-district
  set district-dataset gis:load-dataset "in/districts.accra.asc"
...
to load-urban
  set urban-dataset gis:load-dataset "in/urban_accra.asc"
...
to load-prox-bu2010
  set prox-bu2010-dataset gis:load-dataset "in/prox-bu2010.accra.asc"
...
to export-output-income-status
  ...
  file-open "out/urban_expansion_income_2030.asc"
