...
;; Modified by Dr. Alexandre Pereira Santos alexandre.santos@lmu.de
;; 1. adjusted variable naming for consistency
;; 2. separated inputs for more than one case study by including different folders. Also adjusted file names removing 'Accra' from them
;; 3. added comments to the code, notably marking those lines commented out in the original
...
to set-up
  ca
  ;;gis:load-coordinate-system ("data\\in_mumbai\\.prj")
  make-households
  make-developers
...
to load-ULI
  ask patches [
    set ULI (((1 - suburb) * 10) + (nom-neighbourhood * 7) + ((1 - bu2015) * 9) + ((1 - cbd) * 5) + (1 - shoppingmall) +
...
to load-UHI
  ask patches [
    set UHI (((1 - attractive2015) * 10 ) + ((1 - bu2015) * 5) + ((1 - nom-neighbourhood) * 5) + ((1 - suburb) * 2) +
      ((1 - shoppingmall) * 5) + ((1 - markets) * 6) + ((1 - schools) * 4) + ((1 - road) * 3) + ((1 - cbd) * 2) + (density) + (random-float 0.1))
  ]
end
;;.........................................................................
...
to load-UMI
  ask patches [
    set UMI (((1 - attractive2015) * 8) + (nom-neighbourhood * 7) +  ((1 - bu2015) * 6) + ((1 - road) * 7) +
      ((1 - schools) * 4) + ((1 - cbd) * 3) + ((1 - suburb) * 4) + ((1 - markets) * 4) + ((1 - shoppingmall) * 2) +
      (density * 2) + (1 - healthfacilities) + (random-float 0.1))
  ]
end
...
to export-output-income-status
  ...
  file-open "data/out_mumbai/MUM_expansion_income_2023.asc"
...
to export-output-legal-status
  ...
  file-open "data/out_mumbai/MUM_expansion_formality_2023.asc"
  file-print "ncols         595   \r\n"
  file-print "nrows         846   \r\n"
  file-print "xllcorner     253336.3548   \r\n"
  file-print "yllcorner     2041831.0224   \r\n"
...
select-model
select-model
"airport" "attractive2015" "bu2000-dist" "bu2015-dist" "density2000" "density2015" "districts" "exclusion" "income" "landvalue" "road-presence" "slope" "tenure" "urban"
12
